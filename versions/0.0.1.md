...
**NOTE:** need a hierarchy of zones - e.g., greenhouse, horizontal growing layer, vertical column, planting batch, lighting zone, irrigation slab, tables, rows, and so on. Ideally, zones are customer-defined and support inifinite hierarchy.  
