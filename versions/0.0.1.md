...
**NOTE:** need sub-locations - e.g., greenhouse, horizontal growing layer, vertical column, planting batch, lighting zone, irrigation slab, tables, rows, and so on. Ideally, locations are customer-defined and support inifinite hierarchy.
...
| uv.d       | Level of ultraviolet light      | PPFD  |
| infrared.d | Level of infrared light         | PPFD  |
| par.d      | Level of absorbable light       | PPFD  |
| light.d    | Level of all spectrums of light | PPFD  |

### Sensor Configuration

| Name     | Description                    | Unit  |
| -------- | ------------------------------ | ----- |
| location | unique placement of the sensor | uid   |
| distance | Distance from light source     | cm    |
| area     | Area covered by the fixture    | m2    |
...
| min      | lowest light frequency   | nm    |
| max      | highest light frequency  | nm    |
