...
# Data Types
|Type|Description|YAML|
| Boolean  | Used to express T/F, Y/N, or ON/OFF values| type: object
  required:
    - name
    - status
  properties:
    status:
      type: bool                      |
| Integer | Used to express whole 4-byte numbers| type: object
  required:
    - name
    - value
  properties:
    value:
      type: integer|
| Decimal | Used to express numbers with 8-byte decimal precision | type: object
  required:
    - name
    - value
  properties:
    value:
      type: number
      format: double |
| String  | Used to send alphanumeric strings| type: object
  required:
    - name
    - text
  properties:
